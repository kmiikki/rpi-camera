...
print("RGBcombine 1.0, (c) Kim Miikki 2020")
print("")
...
outname="rgbcombine-"+foldername+".txt"
t1=datetime.now()
...
# List all R, G and B pictures and generate new filenames
